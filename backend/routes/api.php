...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::middleware(['admin.access', 'moderator.readonly'])->group(function () {
            Route::get('/moderation/posts', [ModerationController::class, 'getAllPosts']);
            Route::get('/moderation/stats', [ModerationController::class, 'getModerationStats']);
            Route::post('/moderation/posts/{post}/hide', [ModerationController::class, 'hidePost']);
            Route::post('/moderation/posts/{post}/unhide', [ModerationController::class, 'unhidePost']);
        });

        // Rutas de membresías
        Route::prefix('membership')->group(function () {
            Route::post('/checkout', [MembershipController::class, 'createCheckoutSession']);
            Route::post('/confirm', [MembershipController::class, 'confirmPayment']);
            Route::get('/status', [MembershipController::class, 'getMembershipStatus']);
