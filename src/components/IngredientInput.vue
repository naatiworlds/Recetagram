...
.add-button {
  ...
  margin-top: auto; /* Asegurar que el botón esté alineado con los inputs */
}

.inputs-container {
  margin-bottom: 20px; /* Espaciado entre inputs y lista */
}
...
.scrollable-list {
  ...
  border: 1px solid var(--sombra-color); /* Opcional: para delimitar la lista */
  border-radius: 6px; /* Opcional: bordes redondeados */
  background-color: #f9f9f9; /* Fondo claro para diferenciar la lista */
}
