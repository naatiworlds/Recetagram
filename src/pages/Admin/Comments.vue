<template>
  <div class="admin-page">
    ...
    <div class="admin-filters">
      <input type="text" v-model="searchTerm" placeholder="Buscar comentarios..." class="search-input" />
    ...
    <div v-else class="admin-cards-container">
      <div v-for="comment in filteredComments" :key="comment.id" class="admin-card">
        <div class="card-header">
          <div class="comment-avatar"><i class="fas fa-comment"></i></div>
  ...
  computed: {
    filteredComments() {
      return this.comments.filter(comment => {
        const matchesSearch = comment.content.toLowerCase().includes(this.searchTerm.toLowerCase()) ||
          (comment.user?.name || '').toLowerCase().includes(this.searchTerm.toLowerCase())

        const matchesPost = !this.postFilter || comment.post_id.toString() === this.postFilter.toString()
